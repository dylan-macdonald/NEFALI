...
class ModelHook:
        ...
        with self.nnsight_model.trace(prompt) as tracer:
            ...
            for layer_idx in layer_indices:
                ...
                if layer_idx >= len(self.model.model.layers) or layer_idx < 0:
                    raise ValueError(f"Layer index {layer_idx} out of range [0, {len(self.model.model.layers)})")
    ...
    def get_scalar_reward(self, activations: Dict[str, torch.Tensor], 
